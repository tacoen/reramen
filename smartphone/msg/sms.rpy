init -200 python:
    ...
    class ramen_messages(ramen_object):
        ...
        def msg(self,msg_id,attr=None,value=None):
            ...
            if attr is None:
                try: return self._msg[msg_id].__dict__
                except: return False

            if value is None:
                try: return self._msg[msg_id].__dict__[attr]
                except: return None
...
init -20 python:
    ...
    sms.newmsg('m03',"[mc_name]??",reply=['You can come now.','What?'], sender='malika')
            ...
            hbox yalign 1.0 xfill True:
                ...
                python:
                    ...
                    if msg.select is None:
                        del_action = [ Function(sms.delete,list=dell), SetScreenVariable('page',None) ]
                    else:
                        del_action = None
